...
struct helper {
    ...
    static func showAlert(withTitle:String, message:String?, controller:UIViewController?) {
    ...
    //
    //        let date = Date()
    //        let dateString = date.format(with: "ddMMyyyyHHmmss")
    //        return "image\(dateString).png"
    //    }
    ...
    static func getDateTimeForServer(date:Date) -> String{
...
//    static  func isvaliname(enterdName:String) -> Bool {
//
//        guard enterdName != nil else { return false }
//
//        let usernameformat =  "^[0-9a-zA-Z\\_]{7,18}$"
//        let namelPredicate = NSPredicate(format:"SELF MATCHES %@", usernameformat)
//        return namelPredicate.evaluate(with: enterdName)
//
//    }
//
